...
void sda_pin_mode(GPIOMode_TypeDef pin_mode)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_9;		//µÚ7¸ùÒý½Å
	GPIO_InitStructure.GPIO_Mode= pin_mode;	//Êä³ö/ÊäÈëÄ£Ê½
	...
	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;	//Ã»ÓÐÊ¹ÄÜÉÏÏÂÀ­µç×è
...
{ 	
	...
	//ÅäÖÃPB6 PB7ÎªÊä³öÄ£Ê½
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_8|GPIO_Pin_9;		//µÚ8 9¸ùÒý½Å
